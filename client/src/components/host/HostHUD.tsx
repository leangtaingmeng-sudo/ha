...
import { ExportModal } from '../common/ExportModal.js';
import {
  QrCode,
  Users,
  Copy,
...
export const HostHUD: React.FC<HostHUDProps> = ({
  ...
  const [exportData, setExportData] = useState<SessionExportData | null>(null);
  ...
  const handleEndSession = () => {
    if (window.confirm('Are you sure you want to end this class session? The room will be locked for submissions.')) {
      setIsEnding(true);
